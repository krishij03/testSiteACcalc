...
const Calculator = () => {
  ...
  const renderLowLevelInputs = () => (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
      <div>
        <label className="block text-gray-700 text-sm md:text-base mb-2">Room Length (ft)</label>
        <input
          type="number"
          ...
          className="w-full p-2 md:p-3 border rounded focus:ring-2 focus:ring-emerald-500"
        />
      </div>
      <div>
  ...
  const renderMediumLevelInputs = () => (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mt-4">
      <div>
        <label className="block text-gray-700 text-sm md:text-base mb-2">Number of Occupants</label>
        <input
          type="number"
      ...
      <div>
        <label className="block text-gray-700 text-sm md:text-base mb-2">Window Area (sq ft)</label>
        <input
          type="number"
      ...
      <div>
        <label className="block text-gray-700 text-sm md:text-base mb-2">Floor Level</label>
        <select
      ...
      <div>
        <label className="block text-gray-700 text-sm md:text-base mb-2">Kitchen in Room?</label>
  ...
  const renderHighLevelInputs = () => (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mt-4">
      <div>
        <label className="block text-gray-700 text-sm md:text-base mb-2">Window Orientation</label>
        <select
      ...
      <div>
        <label className="block text-gray-700 text-sm md:text-base mb-2">Wall Insulation</label>
        <select
      ...
      <div>
        <label className="block text-gray-700 text-sm md:text-base mb-2">Room Usage</label>
        <select
      ...
      <div>
        <label className="block text-gray-700 text-sm md:text-base mb-2">Appliance Load (Watts)</label>
        <input
          type="number"
      ...
      <div>
        <label className="block text-gray-700 text-sm md:text-base mb-2">Sunlight Hours</label>
        <input
          type="number"
      ...
      <div>
        <label className="block text-gray-700 text-sm md:text-base mb-2">Ventilation Rate (ACH)</label>
        <input
          type="number"
          step="0.1"
      ...
      <div>
        <label className="block text-gray-700 text-sm md:text-base mb-2">Building Material</label>
        <select
      ...
      <div>
        <label className="block text-gray-700 text-sm md:text-base mb-2">Roof Exposure</label>
        <div className="flex items-center space-x-4 mt-2">
          <label className="inline-flex items-center">
            <input
              type="radio"
  ...
  return (
    <section id="calculator" className="py-12 md:py-20 bg-white">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl md:text-3xl font-bold text-center mb-8">AC Tonnage Calculator</h2>
        
        <div className="max-w-4xl mx-auto">
          {/* Customization Level Selector */}
          <div className="mb-8">
            <h3 className="text-lg md:text-xl font-semibold mb-4">Choose Customization Level</h3>
          ...
          <div className="bg-white rounded-lg shadow-lg p-4 md:p-6">
            ...
            <div className="mt-8">
              <button
                ...
                className="w-full py-3 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition duration-300 text-sm md:text-base"
              >
            ...
            {/* Results Section */}
            {result && (
              <div className="mt-6 p-4 md:p-6 bg-emerald-50 rounded-lg">
                <h3 className="text-lg md:text-xl font-semibold mb-2">Recommended AC Tonnage:</h3>
